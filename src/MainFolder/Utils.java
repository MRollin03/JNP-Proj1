...
public class Utils {
     ...
     * 
     * @param difference   the diffrens between to integes, example: x-cords or
     *                     y-cords
    ...
    /**
     * Function that checks if there is a given 'object' in a given radius, from a
     * location.
     * 
     * @param l        the center location for the search
     * @param objClass The type of class to search after
     * @param radius   the radius in which to search
     * @return returns the location of the object found or null if no objects within
     *         radius
     */
     ...
     * 
     * @param size size is the size of the world f.ex if 5, 5 X 5 there should be 25
     *             possible locations
